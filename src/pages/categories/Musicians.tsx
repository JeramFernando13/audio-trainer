...
import { Music, Target, GraduationCap, Check, BarChart3, RotateCcw, Lightbulb, Piano, Music2 } from 'lucide-react';
...
export const Musicians = () => {
  const learnSections = [
    ...
    {
      title: 'Accordi',
      description: 'Scopri tutti gli accordi con esempi pratici e teoria musicale.',
      icon: Piano,
      path: '/learn/chords',
  ...
  const trainSections = [
      {
      title: 'Chord Quiz',
      description: 'Riconosci gli accordi partendo da qualsiasi nota.',
      icon: Piano,
      path: '/train/chords',
    ...
    {
      title: 'Interval Quiz',
      description: 'Metti alla prova la tua capacità di identificare intervalli ascendenti partendo da qualsiasi nota.',
      icon: Music,
    ...
    <div className="space-y-12 pb-12">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-3 mb-4">
          <Music2  className="w-12 h-12 text-blue-600 dark:text-blue-600" />
        ...
        <div className="flex gap-4 justify-center pt-4">
          ...
          <div className="bg-indigo-100 dark:bg-indigo-900/30 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2">
