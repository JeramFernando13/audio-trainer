...
import {  Target, GraduationCap, Check, BarChart3, RotateCcw, Lightbulb, MicVocal, Speech } from 'lucide-react';
    ...
    <div className="space-y-12 pb-12">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-3 mb-4">
          <MicVocal  className="w-12 h-12 text-green-600 dark:text-green-600" />
          <h1 className="text-5xl font-bold text-gray-900 dark:text-white">
            Voice Trainer
          </h1>
        </div>
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Allena la tua voce con esercizi interattivi e progressivi.
        </p>
        <div className="flex gap-4 justify-center pt-4">
          
          <div className="bg-emerald-100 dark:bg-emerald-900/30 text-green-700 dark:text-green-300 px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2">
