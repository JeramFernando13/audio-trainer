...
import { Target, GraduationCap, Check, BarChart3, RotateCcw, Lightbulb, Sliders, Waves, AudioWaveform } from 'lucide-react';
    ...
    <div className="space-y-12 pb-12">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-3 mb-4">
          <AudioWaveform   className="w-12 h-12 text-purple-600 dark:text-purple-600" />
        ...
        <div className="flex gap-4 justify-center pt-4">
          ...
          <div className="bg-purple-100 dark:bg-purple-900/30 text-violet-700 dark:text-violet-300 px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2">
